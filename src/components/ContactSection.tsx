...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="bg-[var(--bg)] px-5 sm:px-8 md:px-10 pt-20 sm:pt-24 md:pt-28 pb-20 sm:pb-24 md:pb-32">
      <FadeIn delay={0} y={40}>
      ...
      <FadeIn delay={0.1} y={30}>
        <p className="text-[var(--text)] font-light text-center leading-relaxed max-w-[500px] mx-auto mb-12"
